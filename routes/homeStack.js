...
function ScreenMenu({navigation}) {

  const CarListNavigator = () => {
    navigation.navigate('Screen_CarList');
  };
        ...
        <ImageBackground
          ...
          <View style={styles.Logo}>
            ...
            <Image
              ...
              source={require('../image/unnamed.png')}></Image>
            <Text style={styles.Title}>Car List App</Text>
          </View>
        </ImageBackground>
        <View style={styles.LoginContainer}>
          <View style={styles.LoginInputContainer}>
            <Text style={styles.LoginContentTitle}>System Menu</Text>
...
<Item floatingLabel style={{borderColor:'#4632A1',marginTop:20}}>
  ...
  <Icon name="eye" style={{color: '#4632A1'}} />
              ...
              <Button
                ...
                onPress={CarListNavigator}>
                <Text style={styles.ButtonText}>Check Car Owner</Text>
              </Button>
              ...
              <Button
                ...
                style={[
                  styles.MenuButton,
                  styles.ShadowButton,
                  {shadowColor: '#111111', marginTop: 20},
                ]}>
